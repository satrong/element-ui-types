...
export interface ElUploadHttpRequestOptions {
 ...
 */
export type ElUpload = TComponent<{
  /** 必选参数，上传的地址 */
  action: string
  /** 设置上传的请求头部 */
  headers?: Record<string, string>
  ...
  accept?: string
  /** 点击文件列表中已上传的文件时的钩子 */
  onPreview?: (file: ElUploadFile) => void
  /** 文件列表移除文件时的钩子 */
  onRemove?: (file: ElUploadFile, fileList: ElUploadFile[]) => void
  /** 文件上传成功时的钩子 */
  onSuccess?: (response: any, file: ElUploadFile, fileList: ElUploadFile[]) => void
  /** 文件上传失败时的钩子 */
  onError?: (err: any, file: ElUploadFile, fileList: ElUploadFile[]) => void
  /** 文件上传时的钩子 */
  onProgress?: (event: any, file: ElUploadFile, fileList: ElUploadFile[]) => void
  ...
  limit?: number
  /** 文件超出个数限制时的钩子 */
  onExceed?: (files: ElUploadFile, fileList: ElUploadFile[]) => void
}, {
  /** 清空已上传的文件列表（该方法不支持在 before-upload 中调用） */
  clearFiles: () => void
  /** 取消上传请求 */
  abort: (file: ElUploadFile) => void
  /** 手动上传文件列表 */
  submit: () => void
}>
